<svelte:head>
  ...
  <meta name="description" content="Prenez rendez-vous en ligne au cabinet d'esthétique Ellessé. Réservez votre soin de beauté à la russe en quelques clics." />
...
<div class="page-wrapper">
  <header>
    ...
    <nav class:open={menuOpen} aria-label="Navigation principale">
      ...
      <a 
        href="/rendez-vous" 
        class:active={currentPath.includes("/rendez-vous")}
        onclick={closeMenu}
        aria-current={currentPath.includes("/rendez-vous") ? "page" : undefined}
      >Rendez-vous</a>
